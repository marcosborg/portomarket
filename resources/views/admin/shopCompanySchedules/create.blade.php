...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.shopCompanySchedule.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.shop-company-schedules.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('monday_morning_opening') ? 'is-invalid' : '' }}" type="text" name="monday_morning_opening" id="monday_morning_opening" value="{{ old('monday_morning_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('monday_morning_closing') ? 'is-invalid' : '' }}" type="text" name="monday_morning_closing" id="monday_morning_closing" value="{{ old('monday_morning_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('moday_afternoon_opening') ? 'is-invalid' : '' }}" type="text" name="moday_afternoon_opening" id="moday_afternoon_opening" value="{{ old('moday_afternoon_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('monday_afternoon_closing') ? 'is-invalid' : '' }}" type="text" name="monday_afternoon_closing" id="monday_afternoon_closing" value="{{ old('monday_afternoon_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('tuesday_morning_opening') ? 'is-invalid' : '' }}" type="text" name="tuesday_morning_opening" id="tuesday_morning_opening" value="{{ old('tuesday_morning_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('tuesday_morning_closing') ? 'is-invalid' : '' }}" type="text" name="tuesday_morning_closing" id="tuesday_morning_closing" value="{{ old('tuesday_morning_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('tuesday_afternoon_opening') ? 'is-invalid' : '' }}" type="text" name="tuesday_afternoon_opening" id="tuesday_afternoon_opening" value="{{ old('tuesday_afternoon_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('tuesday_afternoon_closing') ? 'is-invalid' : '' }}" type="text" name="tuesday_afternoon_closing" id="tuesday_afternoon_closing" value="{{ old('tuesday_afternoon_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('wednesday_morning_opening') ? 'is-invalid' : '' }}" type="text" name="wednesday_morning_opening" id="wednesday_morning_opening" value="{{ old('wednesday_morning_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('wednesday_morning_closing') ? 'is-invalid' : '' }}" type="text" name="wednesday_morning_closing" id="wednesday_morning_closing" value="{{ old('wednesday_morning_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('wednesday_afternoon_opening') ? 'is-invalid' : '' }}" type="text" name="wednesday_afternoon_opening" id="wednesday_afternoon_opening" value="{{ old('wednesday_afternoon_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('wednesday_afternoon_closing') ? 'is-invalid' : '' }}" type="text" name="wednesday_afternoon_closing" id="wednesday_afternoon_closing" value="{{ old('wednesday_afternoon_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('thursday_morning_opening') ? 'is-invalid' : '' }}" type="text" name="thursday_morning_opening" id="thursday_morning_opening" value="{{ old('thursday_morning_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('thursday_morning_closing') ? 'is-invalid' : '' }}" type="text" name="thursday_morning_closing" id="thursday_morning_closing" value="{{ old('thursday_morning_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('thursday_afternoon_opening') ? 'is-invalid' : '' }}" type="text" name="thursday_afternoon_opening" id="thursday_afternoon_opening" value="{{ old('thursday_afternoon_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('thursday_afternoon_closing') ? 'is-invalid' : '' }}" type="text" name="thursday_afternoon_closing" id="thursday_afternoon_closing" value="{{ old('thursday_afternoon_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('friday_morning_opening') ? 'is-invalid' : '' }}" type="text" name="friday_morning_opening" id="friday_morning_opening" value="{{ old('friday_morning_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('friday_morning_closing') ? 'is-invalid' : '' }}" type="text" name="friday_morning_closing" id="friday_morning_closing" value="{{ old('friday_morning_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('friday_afternoon_opening') ? 'is-invalid' : '' }}" type="text" name="friday_afternoon_opening" id="friday_afternoon_opening" value="{{ old('friday_afternoon_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('friday_afternoon_closing') ? 'is-invalid' : '' }}" type="text" name="friday_afternoon_closing" id="friday_afternoon_closing" value="{{ old('friday_afternoon_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('saturday_morning_opening') ? 'is-invalid' : '' }}" type="text" name="saturday_morning_opening" id="saturday_morning_opening" value="{{ old('saturday_morning_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('saturday_morning_closing') ? 'is-invalid' : '' }}" type="text" name="saturday_morning_closing" id="saturday_morning_closing" value="{{ old('saturday_morning_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('saturday_afternoon_opening') ? 'is-invalid' : '' }}" type="text" name="saturday_afternoon_opening" id="saturday_afternoon_opening" value="{{ old('saturday_afternoon_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('saturday_afternoon_closing') ? 'is-invalid' : '' }}" type="text" name="saturday_afternoon_closing" id="saturday_afternoon_closing" value="{{ old('saturday_afternoon_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('sunday_morning_opening') ? 'is-invalid' : '' }}" type="text" name="sunday_morning_opening" id="sunday_morning_opening" value="{{ old('sunday_morning_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('sunday_morning_closing') ? 'is-invalid' : '' }}" type="text" name="sunday_morning_closing" id="sunday_morning_closing" value="{{ old('sunday_morning_closing') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('sunday_afternoon_opening') ? 'is-invalid' : '' }}" type="text" name="sunday_afternoon_opening" id="sunday_afternoon_opening" value="{{ old('sunday_afternoon_opening') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('sunday_afternoon_closing') ? 'is-invalid' : '' }}" type="text" name="sunday_afternoon_closing" id="sunday_afternoon_closing" value="{{ old('sunday_afternoon_closing') }}">
