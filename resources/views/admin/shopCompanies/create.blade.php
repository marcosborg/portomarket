    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.shop-companies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_free_after') ? 'is-invalid' : '' }}" type="number" name="delivery_free_after" id="delivery_free_after" value="{{ old('delivery_free_after', '') }}" step="0.01">
