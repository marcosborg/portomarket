...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.serviceDuration.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.service-durations.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minutes') ? 'is-invalid' : '' }}" type="number" name="minutes" id="minutes" value="{{ old('minutes', '') }}" step="1" required>
